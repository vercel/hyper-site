...
The latest version includes several enhancements that make Hyper _really_ fast.
...
how little time it took from _"let's make this thing faster"_ to _"Holy shell! That's fast!"_
...
<img className="oversize" src="/blog/hyper2.png" load="lazy" width="5469" height="1297" />
<p className="caption">Hyper 2</p>
<img className="oversize" src="/blog/hyper3.png" load="lazy" width="5493" height="1315" />
<p className="caption">Hyper 3</p>
<p className="caption">
...
<img src="/blog/supports-emoji.png" load="lazy" width="1062" height="950" />
  <p className="caption">With the new emoji support, introducing emoji within Git commits (or elsewhere) is easier than ever.</p>
<br/>
...
<p className="caption">Hyper supports themes, allowing you to customise your development experience.</p>
