...
```
{
  // The example is written in the format expected in the file but it contains comments that do not go into the file but are just there to give more information on what you can provide.
