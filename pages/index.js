...
export default () => {
  ...
  useEffect(() => {
    ...
    fetch('https://api.github.com/repos/zeit/hyper/releases/latest')
      .then(r => r.json())
      .then(({ tag_name }) => setTagName(tag_name))
  }, [])
    ...
    <Page>
      ...
      <div id="main">
        <div id="top">
          ...
          <div id="video">
            <video id="vid" src="/hyperapp.mp4" height="100%" autoPlay muted />
          </div>
        ...
        <div id="content">
          ...
          <p>
            Then edit <PathLink os={os} path=".hyper.js" type="config" /> and
          ...
          <p>
            ...
            installed to{' '}
            <PathLink os={os} path=".hyper_plugins" type="plugins" />.
          </p>
          ...
          <p>
            ...
            be ignored, if config in application directory present. Otherwise it
            will be moved to the application directory at first run.
          </p>
          <p>
          ...
          <p>
            ...
            APIs we use to build the terminal: <code>React</code> components and{' '}
          ...
          <p>
            ...
            (refresh). Please strive to make plugins that don't require a
                ...
                <tr>
                  ...
                  <td>
                    <p>
                      ...
                      optional parameter which can be used to log details to the
                      development console.
                    </p>
                    <p>
          ...
          <p>
            ...
            notice that some classes are automatically generated and followed by
            a random nonce (e.g.: <code>term_13hv8io</code>). Ignore those: they
            change with every new window!
          </p>
          <p>
