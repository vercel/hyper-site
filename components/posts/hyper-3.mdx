...
<div className="heading">
  <h1>Hyper 3</h1>
  <time datetime="2019-05-05">Friday, May 5rd 2019</time>
</div>
  ...
  <li>
    <Author
      data={{
        name: 'Test Ing',
        handle: '@testing_',
        thumbnail: 'https://zeit.co/api/www/avatar/?u=hharnisc&s=160',
        url: 'https://twitter.com/testing_'
      }}
    />
  </li>
  <li>
...
<Image  width={1756 / 2.5} height={1038 / 2.5} src="../../static/batching.svg"/>
<Caption>
...
<Image src="../../static/emoji.png" width={1208 / 2.5} height={740 / 2.5}/>
<br/>
<br/>
