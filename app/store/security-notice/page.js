...
export const metadata = {
  ...
  description: 'Security notice for Hyper Store plugins and themes',
}
...
export default function SecurityNoticePage() {
  ...
  "hyperpower#0.2.2",
        ...
        <h2>What can I do to report malicious content listed on the Hyper Store?</h2>
        
        <p>
          The best thing to do would be to submit an issue on <a href="https://github.com/vercel/hyper-site/">this repository</a>.
